...
union(){
  ...
  translate([17.5/2,0,0])cube([16+17.5+4,60,15],center=true);
  translate([0,40-10,0])cylinder(r=10,h=15,center=true);
  translate([0,-40+10,0])cylinder(r=10,h=15,center=true);

  // Registro perfil alu
  translate([48/2+10,0,0])cube([20,30,15],center=true);

}

union(){

  translate([20,25,0])cube([20,20,15],center=true);
  translate([20,-25,0])cube([20,20,15],center=true);
